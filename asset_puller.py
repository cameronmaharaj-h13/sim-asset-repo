#!/usr/bin/env python3
"""
MoE Sim Asset Puller
--------------------------------
Same two zones as before:

  1. assets/Subjects/<Subject>/
  2. assets/Simulation Backgrounds/<Category>/
...
SETUP: unchanged from v2.
  ...
  6. Run:  python asset_puller.py
  7. Output lands in ./assets/ -- drag straight into Drive.
...
def main():
    ...
    with open(manifest_path, "w") as f:
        ...
        f.write("Auto-generated by asset_puller.py\n\n")
